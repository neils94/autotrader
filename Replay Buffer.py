...
class ReplayBuffer():
    def __init__(self, buffer_size, batch_size):
        self.experience = namedtuple(typename = "experience", field_names=["states", "actions", "rewards", "next_states", "close"])
        self.memory = deque(maxlen=buffer_size)
        self.buffer_size = buffer_size
        self.batch_size = batch_size
        
        
    def add(self, states, actions, rewards, next_states, close):
        exp = self.experience(states, actions, rewards, next_states, close)
    ...
    def sample(self):
        ...
        return (states, actions, rewards, next_states, open, close)
